...
import kotlinx.android.synthetic.main.fragment_complain_money_type.*
import java.io.File

/**
 * 拖欠工资投诉
 * Created By bhx On 2019/8/26 0026 10:04
 */
class ComplainMoneyTypeFragment : BaseLazyFragment() {

    private lateinit var mPhotoLisAdapter: PhotoListAdapter
    private val mPhotoList = mutableListOf<File>()
    private var mDisposable: Disposable? = null

    override fun getLayoutId(): Int = R.layout.fragment_complain_money_type
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tvSubmit.clickWithTrigger {
            val charge = etInputAmount.text.toString().trim()
    ...
    private fun changeSubmitStatus() {
        ...
        val isEnabled = charge.isNotEmpty() && content.isNotEmpty()
        if (isEnabled) {
