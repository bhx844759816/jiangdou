package com.jxqm.jiangdou.ui.city.view;
...
public class SideIndexBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextSize = typedArray.getDimension(R.styleable.SideIndexBar_cpIndexBarTextSize, DensityUtil.dip2px(context, 13f));
        mTextColor = typedArray.getColor(R.styleable.SideIndexBar_cpIndexBarNormalTextColor, Color.parseColor("#474747"));
        mTextTouchedColor = typedArray.getColor(R.styleable.SideIndexBar_cpIndexBarNormalTextColor, Color.parseColor("#474747"));
        typedArray.recycle();
