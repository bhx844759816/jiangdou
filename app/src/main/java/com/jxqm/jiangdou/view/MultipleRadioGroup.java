...
/**
 * Created By bhx On 2019/8/8 0008 08:48
 */
public class MultipleRadioGroup extends LinearLayout {
    ...
    public MultipleRadioGroup(Context context, AttributeSet attrs) {
        ...
        TypedArray t = getContext().obtainStyledAttributes(attrs,
                R.styleable.MultipleRadioGroup);
        isSupportMultiple = t.getBoolean(R.styleable.MultipleRadioGroup_isSupportMultiple, false);
        t.recycle();
        init();
    }
    ...
    private void registerTouchListener(View child) {
            ...
            child.setOnTouchListener((v, event) -> {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (mOnCheckedChangeListener != null) {
                        mOnCheckedChangeListener.onCheckedChanged(MultipleRadioGroup.this, child.getId());
                    }
                }
                return true;
            });
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        void onCheckedChanged(MultipleRadioGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == MultipleRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
